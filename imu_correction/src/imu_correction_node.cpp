...
void yaw_offset_degree_Callback(const std_msgs::Float64::ConstPtr &msg)
{
...
int main(int argc, char **argv)
{
	...
	ros::init(argc, argv, "imu_correction node");
	ros::NodeHandle nh;
	...
	ros::Subscriber sub_imu_               = nh.subscribe(imu_topic, 1, imu1Callback);
	ros::Subscriber sub_yaw_offset_degree  = nh.subscribe(yaw_offset_degree_topic, 1, yaw_offset_degree_Callback);
