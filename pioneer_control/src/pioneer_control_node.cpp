...
int main(int argc, char **argv)
{
    ...
    //ros::Subscriber sub_line_cmd_vel       = nh.subscribe(line_cmd_vel_topic, 1, chatterCallback);
    ...
    while (ros::ok())
    {
      ...
      switch(mission_flag)
      {
         ...
         if(yaw_degree < 180.5 && yaw_degree >= 180)         
         {
            mission_flag++;
         }
